...
new Vue({
    ...
    methods: {
        ...
        checkGameStatus() {
            if (this.playerWins()) {
                Swal.fire("Ganador! la palabra es " + this.getUnhiddenWord());
                this.resetGame();
            }
            if (this.playerLoses()) {
                Swal.fire("Perdedor. no es la palabra" + this.getUnhiddenWord());
                this.resetGame();
            }
        },
        getUnhiddenWord() {
        ...
        async chooseWord() {
            ...
            if (!words.length) {
                await Swal.fire("Agregue algunas palabras para poder jugar (vaya a Administrar palabras)");
